...
INSERT INTO `sale` (`idsale`,`date`,`customer`,`amount`,`net_amount`,`discount`,`remark`) VALUES 
 (1,'2020-05-15 15:27:46',1,84500,84500,0,''),
 (2,'2020-05-17 03:49:23',3,85000,85000,0,''),
 (3,'2020-05-17 04:01:12',3,43000,43000,0,''),
 (4,'2020-05-17 04:30:29',3,91000,91000,0,''),
 (5,'2020-05-17 04:34:49',1,92000,92000,0,'');
...
INSERT INTO `sale_detail` (`idsale_detail`,`invoice_number`,`item`,`quantity`,`sale_price`,`amount`,`cogs`) VALUES 
 (1,1,21,13,6500,84500,4615),
 (2,2,1,5,4000,20000,3000),
 (3,2,15,5,13000,65000,9125),
 (4,3,1,10,4000,40000,3000),
 (5,3,5,2,1500,3000,1000),
 (6,4,1,10,4000,40000,3000),
 (7,4,9,1,21000,21000,15000),
 (8,4,3,2,15000,30000,10000),
 (9,5,1,3,4000,12000,3000),
 (10,5,16,10,8000,80000,5000);
...
INSERT INTO `stock` (`idstock`,`item_name`,`barcode`,`cost`,`sale_price`,`quantity`,`limit_quantity`,`remark`) VALUES 
 (1,'Test1','0000000001',3000,4000,2,3,''),
 (2,'Test2','0000000002',70000,90000,5,2,''),
 (3,'Test3','0000000003',10000,15000,18,5,''),
 (4,'Test4','0000000004',200000,260000,2,1,''),
 (5,'Test5','0000000005',1000,1500,48,20,''),
 ...
 (9,'Test9','0000000009',15000,21000,19,5,''),
 ...
 (15,'linlin5','0000000015',9125,13000,35,3,''),
 (16,'linlin6','0000000016',5000,8000,10,3,''),
 ...
 (21,'Testing2','0000000021',4615,6500,100,15,''),
