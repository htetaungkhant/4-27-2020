	...
	public static Object[][] retrieveAll(){
		...
		try {
			...
			while(resultSet.next()){
					++row;
					result[row][0]=resultSet.getInt("idcustomer");
...
//			}
	...
	public static void update(Object[] data, int id){
		Connection connection = DBConnection.createConnection();
		String query = "UPDATE customer SET customer_name=?,phone=?,address=? WHERE idcustomer=?";
		try {
